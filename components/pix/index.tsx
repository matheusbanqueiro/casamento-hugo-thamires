...
export default function Pix() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4 p-6">
      ...
      {copied && (
        <span className="absolute shadow-lg inline-flex items-center rounded-md bg-primary px-2 py-1 text-sm font-medium text-secondary ring-1 ring-inset ring-gray-500/10">
      ...
      <div className="flex rounded-md bg-terciary p-3 text-xl font-bold">
        <span>{cpf}</span>
        <button className="ml-2 flex cursor-pointer" onClick={copyToClipboard}>
